...
def backfill(date: str = None) -> None:
    ...
    params: SimulationParams = SimulationParams(iterations=2000,
                                                max_batch_size=200,
                                                ignore_results_after=date,
                                                load_results=True)
    simulator_adapter: PoissonSameVenueAverageAdapter = PoissonSameVenueAverageAdapter(params.strategy)
