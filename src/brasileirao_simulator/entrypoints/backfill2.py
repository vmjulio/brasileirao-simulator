...
from brasileirao_simulator.adapters.poisson_weighted_venue_average_adapter import PoissonWeightedVenueAverageAdapter
...
def backfill(date: str = None) -> None:
    ...
    params: SimulationParams = SimulationParams(iterations=300,
                                                ...
                                                load_results=True,
                                                strategy="weighted")
    simulator_adapter: PoissonSameVenueAverageAdapter = PoissonWeightedVenueAverageAdapter(params.strategy)
