...
def inspect_dataset(dataset_name: str = None) -> None:
    ...
    standings = FixtureSimulatorAdapter().get_brasileirao_standings(enriched_tidy_fixtures)
    team_params = FixtureSimulatorAdapter().get_team_params(enriched_tidy_fixtures)
